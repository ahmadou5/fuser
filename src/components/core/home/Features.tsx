...
import { AppFeatures, Stats } from "@/utils/itemList";
...
function Card({
  ...
  return (
    <div
      className={`relative grid lg:grid-cols-2  gap-12 items-center lg:mt-[200px] lg:mb-[200px] mt-12 mb-12`}
      id="about"
    >
      <motion.div
        ...
        viewport={{ once: false }}
        className={`${isLeft ? "order-1" : "order-2"} px-3 py-4`}
      >
        <Image
          src={iconUrl}
          ...
          width={500}
          height={600}
          className="w-[70%] h-auto ml-auto mr-auto"
        />
      </motion.div>
      <motion.div
        initial={{ opacity: 0, x: 20 }}
        ...
        transition={{ duration: 0.5 }}
        viewport={{ once: false }}
        className={`${isLeft ? "order-2" : "order-1"} px-3 py-4 lg:mb-[340px]`}
      >
        <h2 className="text-3xl lg:text-4xl font-bold mb-6 text-[#0A7EA4]">
          {title}
        </h2>
        <p className="text-gray-400 lg:text-xl">{description}</p>
      </motion.div>
    </div>
  );
}
{
  /**  old implementations of feature card
  ...
  return (
    <section className="relative py-20 lg:py-28">
      <motion.div
        ...
        transition={{ duration: 0.5 }}
        viewport={{ once: false }}
        className="p-5 mb-12 bg-white/5 backdrop-blur-sm border-b border-primary"
      >
      ...
      <div className="container lg:mt-[300px]   px-4 mx-auto">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          viewport={{ once: false }}
          className="text-center lg:mb-[250px]"
        >
          ...
          <div className="inline-block px-4 py-2 mb-8 rounded-lg border border-primary/20 bg-[#1A1B1E]/60 backdrop-blur-sm ">
            <p className="text-gray-400 lg:text-sm text-xs">
              {" "}
              A comprehensive platform with features that are tailored to the
              needs of users.
            </p>
          </div>
        </motion.div>
      ...
      <Image
        ...
        width={500}
        height={600}
        className="absolute right-0 left-0 bottom-0 lg:bottom-26 w-full h-auto"
      />
    </section>
  );
}
