      ...
      <div className="min-h-[700px] flex items-center justify-center p-6">
        <div className="relative w-full max-w-md p-8 rounded-2xl overflow-hidden backdrop-blur-lg bg-white/10 border border-white/20 shadow-xl animate-fade-in">
          ...
          <div className="w-[90%] ml-auto mr-auto mt-6 items-center justify-center flex">
            <Button
              //variant="secondary"
              className="bg-[#0095FF] ml-auto mr-auto w-[60%] text-white hover:bg-[#0095FF]/90"
              onClick={() => router.back()}
            >
              Back Home
            </Button>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2 animate-slide-up">
              ...
              <input
                ...
                placeholder="Enter your name chad"
              />
            </div>
            ...
            <button
              ...
              className="w-full py-3 px-6 rounded-lg bg-[#0095FF] hover:bg-[#0095FF]/90 text-white font-medium hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-blue-500 transform transition-all hover:scale-[1.02] disabled:opacity-70 animate-slide-up flex items-center justify-center space-x-2"
            >
              {status === "loading" ? (
                <>
